...
echo_and_run cd "/home/crslab/catkin_control/src/robots/franka_control_wrappers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/crslab/catkin_control/src/robots/franka_control_wrappers/setup.py" \
     \
    build --build-base "/home/crslab/catkin_control/build/robots/franka_control_wrappers" \
    install \
    --root="${DESTDIR-/}" \
